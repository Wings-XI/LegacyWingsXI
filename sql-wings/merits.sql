...
--
-- Host: localhost
-- Generation Time: Jan 01, 2021 at 07:21 PM
...
INSERT INTO `merits` VALUES(768, 'shield_bash_recast', 5, 10, 64, 6, 11);
INSERT INTO `merits` VALUES(770, 'holy_circle_recast', 5, 20, 64, 6, 11);
...
INSERT INTO `merits` VALUES(834, 'arcane_circle_recast', 5, 20, 128, 6, 12);
...
INSERT INTO `merits` VALUES(840, 'weapon_bash_recast', 5, 10, 128, 6, 12);
...
INSERT INTO `merits` VALUES(902, 'sic_recast', 5, 4, 256, 6, 13);
...
INSERT INTO `merits` VALUES(1024, 'scavenge_effect', 5, 10, 1024, 6, 15);
...
INSERT INTO `merits` VALUES(1216, 'ancient_circle_recast', 5, 20, 8192, 6, 18);
INSERT INTO `merits` VALUES(1218, 'jump_recast', 5, 3, 8192, 6, 18);
INSERT INTO `merits` VALUES(1220, 'high_jump_recast', 5, 6, 8192, 6, 18);
INSERT INTO `merits` VALUES(1222, 'super_jump_recast', 5, 6, 8192, 6, 18);
INSERT INTO `merits` VALUES(1224, 'spirit_link_recast', 5, 6, 8192, 6, 18);
...
INSERT INTO `merits` VALUES(2048, 'warriors_charge', 5, 150, 1, 7, 31);
...
INSERT INTO `merits` VALUES(2176, 'martyr', 5, 150, 4, 7, 33);
INSERT INTO `merits` VALUES(2178, 'devotion', 5, 150, 4, 7, 33);
INSERT INTO `merits` VALUES(2180, 'protectra_v', 5, 2, 4, 7, 33);
INSERT INTO `merits` VALUES(2182, 'shellra_v', 5, 1, 4, 7, 33);
...
INSERT INTO `merits` VALUES(2368, 'assassins_charge', 5, 150, 32, 7, 36);
INSERT INTO `merits` VALUES(2370, 'feint', 5, 120, 32, 7, 36);
INSERT INTO `merits` VALUES(2372, 'aura_steal', 5, 20, 32, 7, 36);
INSERT INTO `merits` VALUES(2374, 'ambush', 5, 3, 32, 7, 36);
INSERT INTO `merits` VALUES(2432, 'fealty', 5, 150, 64, 7, 37);
INSERT INTO `merits` VALUES(2434, 'chivalry', 5, 150, 64, 7, 37);
INSERT INTO `merits` VALUES(2436, 'iron_will', 5, 19, 64, 7, 37);
INSERT INTO `merits` VALUES(2438, 'guardian', 5, 19, 64, 7, 37);
INSERT INTO `merits` VALUES(2496, 'dark_seal', 5, 150, 128, 7, 38);
INSERT INTO `merits` VALUES(2498, 'diabolic_eye', 5, 150, 128, 7, 38);
INSERT INTO `merits` VALUES(2500, 'muted_soul', 5, 10, 128, 7, 38);
INSERT INTO `merits` VALUES(2502, 'desperate_blows_effect', 5, 500, 128, 7, 38);
INSERT INTO `merits` VALUES(2560, 'feral_howl', 5, 150, 256, 7, 39);
INSERT INTO `merits` VALUES(2562, 'killer_instinct', 5, 150, 256, 7, 39);
INSERT INTO `merits` VALUES(2564, 'beast_affinity', 5, 2, 256, 7, 39);
INSERT INTO `merits` VALUES(2566, 'beast_healer', 5, 1, 256, 7, 39);
INSERT INTO `merits` VALUES(2624, 'nightingale', 5, 150, 512, 7, 40);
INSERT INTO `merits` VALUES(2626, 'troubadour', 5, 150, 512, 7, 40);
INSERT INTO `merits` VALUES(2628, 'foe_sirvente', 5, 5, 512, 7, 40);
INSERT INTO `merits` VALUES(2630, 'adventurers_dirge', 5, 3, 512, 7, 40);
...
INSERT INTO `merits` VALUES(2690, 'flashy_shot', 5, 150, 1024, 7, 41);
INSERT INTO `merits` VALUES(2692, 'snapshot', 5, 2, 1024, 7, 41);
INSERT INTO `merits` VALUES(2694, 'recycle', 5, 5, 1024, 7, 41);
INSERT INTO `merits` VALUES(2752, 'shikikoyo', 5, 150, 2048, 7, 42);
INSERT INTO `merits` VALUES(2754, 'blade_bash', 5, 150, 2048, 7, 42);
INSERT INTO `merits` VALUES(2756, 'ikishoten', 5, 30, 2048, 7, 42);
INSERT INTO `merits` VALUES(2758, 'overwhelm', 5, 1, 2048, 7, 42);
INSERT INTO `merits` VALUES(2816, 'sange', 5, 150, 4096, 7, 43);
...
INSERT INTO `merits` VALUES(2880, 'deep_breathing', 5, 150, 8192, 7, 44);
...
INSERT INTO `merits` VALUES(2944, 'meteor_strike', 5, 1, 16384, 7, 45);
INSERT INTO `merits` VALUES(2946, 'heavenly_strike', 5, 1, 16384, 7, 45);
INSERT INTO `merits` VALUES(2948, 'wind_blade', 5, 1, 16384, 7, 45);
INSERT INTO `merits` VALUES(2950, 'geocrush', 5, 1, 16384, 7, 45);
INSERT INTO `merits` VALUES(2952, 'thunderstorm', 5, 1, 16384, 7, 45);
INSERT INTO `merits` VALUES(2954, 'grandfall', 5, 1, 16384, 7, 45);
INSERT INTO `merits` VALUES(3008, 'convergence', 5, 5, 32768, 7, 46);
INSERT INTO `merits` VALUES(3010, 'diffusion', 5, 150, 32768, 7, 46);
INSERT INTO `merits` VALUES(3012, 'enchainment', 5, 100, 32768, 7, 46);
INSERT INTO `merits` VALUES(3014, 'assimilation', 5, 1, 32768, 7, 46);
INSERT INTO `merits` VALUES(3072, 'snake_eye', 5, 150, 65536, 7, 47);
INSERT INTO `merits` VALUES(3074, 'fold', 5, 150, 65536, 7, 47);
INSERT INTO `merits` VALUES(3076, 'winning_streak', 5, 20, 65536, 7, 47);
INSERT INTO `merits` VALUES(3078, 'loaded_deck', 5, 10, 65536, 7, 47);
INSERT INTO `merits` VALUES(3136, 'role_reversal', 5, 30, 131072, 7, 48);
...
INSERT INTO `merits` VALUES(3200, 'saber_dance', 5, 30, 262144, 7, 49);
INSERT INTO `merits` VALUES(3202, 'fan_dance', 5, 30, 262144, 7, 49);
...
INSERT INTO `merits` VALUES(3272, 'enlightenment', 5, 75, 524288, 7, 50);
