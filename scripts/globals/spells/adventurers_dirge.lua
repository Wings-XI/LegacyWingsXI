...
function onSpellCast(caster,target,spell)
    ...
    local power = -7 - caster:getMerit(tpz.merit.ADVENTURERS_DIRGE)
    ...
    if not (target:addBardSong(caster,tpz.effect.DIRGE,power,0,duration,caster:getID(), tpz.magic.ele.FIRE, 1)) then
