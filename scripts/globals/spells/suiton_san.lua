...
function onSpellCast(caster, target, spell)
    ...
    local bonusAcc = 0
    local bonusMab = caster:getMerit(tpz.merit.SUITON_EFFECT) + caster:getMerit(tpz.merit.HUTON_SAN) -- T1 mag atk
    ...
    params.bonus = caster:getMerit(tpz.merit.SUITON_SAN)
