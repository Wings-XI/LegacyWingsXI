...
function onSpellCast(caster, target, spell)
    ...
    local bonusAcc = 0
    local bonusMab = caster:getMerit(tpz.merit.HYOTON_EFFECT) + caster:getMerit(tpz.merit.HYOTON_SAN) -- T1 mag atk
    ...
    params.bonus = caster:getMerit(tpz.merit.HYOTON_SAN)
