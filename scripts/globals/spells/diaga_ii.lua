...
function onSpellCast(caster, target, spell)
    ...
    -- Do it!
    -- Defense down is 5.1% (http://wiki.ffo.jp/wiki.cgi?Command=HDetail&articleid=129420&id=338)
    target:addStatusEffect(tpz.effect.DIA, 2 + dotBonus, 3, duration, 0, 5, 2)
