...
local atmaMods =
{
    ...
    [tpz.ki.ATMA_OF_THE_DEEP_DEVOURER]          = {tpz.mod.SUBTLE_BLOW, 5, tpz.mod.STORETP, 5, tpz.mod.SONG_SPELLCASTING_TIME_REDUCTION, 20},
    ...
    [tpz.ki.ATMA_OF_BLIGHTED_BREATH]            = {tpz.mod.SONG_SPELLCASTING_TIME_REDUCTION, 40, tpz.mod.LIGHTACC, 40},
