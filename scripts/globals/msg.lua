...
tpz.msg.channel =
{
    ...
    EMOTION         =  8,
    -- 9 / 10 / 11  = Does not work / does nothing.
    ...
    LINKSHELL3      = 30, -- Third LS may have been planned at some point on Retail.
    NS_LINKSHELL3   = 31, -- Same as LINKSHELL_3 but has but has no speaker object displayed.
...
tpz.msg.basic =
{
    ...
    IS_EFFECT               = 277, -- <target> is stunned.
    NO_EFFECT               = 283, -- No effect on <target>.
    NARROWLY_ESCAPE         = 359, -- <target> narrowly escapes impending doom.
    ALL_ABILITIES_RECHARGED = 361, -- All of ${target}'s abilities are recharged.
    TP_REDUCED              = 362, -- The <player> uses .. <target>'s TP is reduced to ...
    AOE_HP_RECOVERY         = 367, -- <target> recovers <amount> HP.
    ATTR_DRAINED            = 369, -- The <player> uses .. .. of <target>'s attributes are drained.
    ...
    DAMAGE                  = 185, -- The <player> uses .. <target> takes .. points of damage.
    DAMAGE_SECONDARY        = 264, -- <target> takes .. points of damage.
    ...
    SKILL_MISS              = 188, -- The <player> uses .. but misses <target>.
    ...
    MAGIC_CANNOT_BE_CAST    =  48, -- <spell> cannot be cast on <target>.
    ...
    MAGIC_COMPLETELY_RESIST     = 655,
    MAGIC_COMPLETELY_RESIST_AOE = 656,
    ...
    HIDE_FAIL               = 240, -- The <player> tries to hide, but is spotted by <target>.
    HIDE_SUCCESS            = 241, -- The <player> hides!
    ...
    COVER_FAIL              = 312, -- The <player>'s attempt to cover has no effect.
    ...
    ADD_EFFECT_STATUS_2     = 164, -- Additional effect: KO. 
