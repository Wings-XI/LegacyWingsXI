    ...
    if (mob:getID() < ID.mob.SHADOW_LORD_STAGE_2_OFFSET) then -- first phase AI
        ...
        if (mob:getHP() / mob:getMaxHP() <= 0.5) then
            ...
            if (mob:AnimationSub() == 0) then
                ...
                -- nullfiy all magic types with an element, this allows formless strikes to do damage in both stances
                mob:addMod(tpz.mod.FIRE_NULL,  100)
                mob:addMod(tpz.mod.ICE_NULL,   100)
                mob:addMod(tpz.mod.WIND_NULL,  100)
                mob:addMod(tpz.mod.EARTH_NULL, 100)
                mob:addMod(tpz.mod.LTNG_NULL,  100)
                mob:addMod(tpz.mod.WATER_NULL, 100)
                mob:addMod(tpz.mod.LIGHT_NULL, 100)
                mob:addMod(tpz.mod.DARK_NULL,  100)
            ...
            elseif (mob:AnimationSub() == 1 and (mob:getHP() <= changeHP - 1000 or
                ...
                mob:AnimationSub(2)
                mob:delMod(tpz.mod.FIRE_NULL,  100)
                mob:delMod(tpz.mod.ICE_NULL,   100)
                mob:delMod(tpz.mod.WIND_NULL,  100)
                mob:delMod(tpz.mod.EARTH_NULL, 100)
                mob:delMod(tpz.mod.LTNG_NULL,  100)
                mob:delMod(tpz.mod.WATER_NULL, 100)
                mob:delMod(tpz.mod.LIGHT_NULL, 100)
                mob:delMod(tpz.mod.DARK_NULL,  100)
