...
function onTrigger(player, npc)
    ...
    elseif player:getCurrentMission(COP) == tpz.mission.id.cop.THE_MOTHERCRYSTALS and (player:hasKeyItem(tpz.ki.LIGHT_OF_HOLLA) or player:hasKeyItem(tpz.ki.LIGHT_OF_DEM) or player:hasKeyItem(tpz.ki.LIGHT_OF_MEA)) then
