...
mobList[zone].waveDefeatRequirements[2] = { DMB+53, DMB+58, DMB+59 } -- Manticore Sands Nightmare Flies
mobList[zone].waveDefeatRequirements[3] = { DMB+52, DMB+56, DMB+57 } -- Sheep Sands Nightmare Flies
mobList[zone].waveDefeatRequirements[4] = { DMB+51, DMB+54, DMB+55 } -- Hippogryph Sands Nightmare Flies
...
mobList[zone][SMB+79 ].waves = { nil, nil, nil, nil, 5 }
mobList[zone][SMB+54 ].waves = { nil, nil, nil, nil, 5 }
mobList[zone][SMB+29 ].waves = { nil, nil, nil, nil, 5 }
mobList[zone][SMB+4  ].waves = { nil, nil, nil, nil, 5 }
mobList[zone][DMB+655].waves = { nil, nil, nil, nil, 5 }
mobList[zone][DMB+433].waves = { nil, nil, nil, nil, 5 }
mobList[zone][DMB+356].waves = { nil, nil, nil, nil, 5 }
mobList[zone][DMB+664].waves = { nil, nil, nil, nil, 5 }
...
mobList[zone][SMB+54 ].specificChildren = { true, DMB+37, SMB+34, SMB+38                                            } -- THF, DRG, SMN (026-Y)
mobList[zone][SMB+29 ].specificChildren = { true, DMB+20, SMB+17, SMB+23                                            } -- THF, DRG, SMN (027-Q)
mobList[zone][SMB+4  ].specificChildren = { true, DMB-17, SMB-6, SMB-2                                              } -- THF, DRG, SMN (028-O)
...
-- Initial Statues
mobList[zone][SMB+50 ].specificChildren = { true, DMB+40, SMB+47, SMB+36                                            } -- WHM, NIN, MNK (001-Y)
mobList[zone][SMB+51 ].specificChildren = { true, DMB+33, SMB+48, SMB+44                                            } -- BRD, BST, DRK (002-Y)
mobList[zone][SMB+52 ].specificChildren = { true, DMB+42, SMB+43, SMB+45                                            } -- PLD, BLM, SAM (003-Y)
mobList[zone][SMB+53 ].specificChildren = { true, DMB+32, SMB+41, SMB+46                                            } -- WAR, RNG, RDM (004-Y)
mobList[zone][SMB+75 ].specificChildren = { true, DMB+65, SMB+73, SMB+69                                            } -- BRD, BST, DRK (006-G)
mobList[zone][SMB+76 ].specificChildren = { true, DMB+71, SMB+70, SMB+64                                            } -- PLD, BLM, SAM (007-G)
mobList[zone][SMB+77 ].specificChildren = { true, DMB+67, SMB+66, SMB+62                                            } -- WHM, NIN, MNK (008-G)
mobList[zone][SMB+78 ].specificChildren = { true, DMB+57, SMB+72, SMB+63                                            } -- WAR, RNG, RDM (009-G)
mobList[zone][SMB+0  ].specificChildren = { true, DMB-14, SMB-8, SMB-13                                             } -- PLD, BLM, SAM (011-O)
mobList[zone][SMB+1  ].specificChildren = { true, DMB-18, SMB-16, SMB-4                                             } -- WAR, RNG, RDM (012-O)
mobList[zone][SMB+2  ].specificChildren = { true, DMB-10, SMB-3, SMB-7                                              } -- BST, BRD, DRK (013-O)
mobList[zone][SMB+3  ].specificChildren = { true, DMB-12, SMB-11, SMB-15                                            } -- WHM, NIN, MNK (014-O)
mobList[zone][SMB+25 ].specificChildren = { true, DMB+19, SMB+10, SMB+13                                            } -- WHM, NIN, MNK (016-Q)
mobList[zone][SMB+26 ].specificChildren = { true, DMB+7, SMB+16, SMB+15                                             } -- WAR, RNG, RDM (017-Q)
mobList[zone][SMB+27 ].specificChildren = { true, DMB+21, SMB+8, SMB+22                                             } -- PLD, BLM, SAM (018-Q)
mobList[zone][SMB+28 ].specificChildren = { true, DMB+9, SMB+11, SMB+14                                             } -- BRD, BST, DRK (019-Q)
mobList[zone][SMB+55 ].specificChildren = { true, DMB+318, SMB+325, SMB+319                                         } -- WAR, RNG, RDM (033-Y)
mobList[zone][SMB+336].specificChildren = { true, DMB+326, SMB+333, SMB+323                                         } -- WHM, NIN, MNK (034-Y)
mobList[zone][SMB+337].specificChildren = { true, DMB+327, SMB+331, SMB+328                                         } -- PLD, BLM, SAM (035-Y)
mobList[zone][SMB+338].specificChildren = { true, DMB+320, SMB+334, SMB+332                                         } -- BRD, BST, DRK (036-Y)
mobList[zone][SMB+339].specificChildren = { true, DMB+324, SMB+329, SMB+321                                         } -- THF, DRG, SMN (037-Y)
mobList[zone][SMB+80 ].specificChildren = { true, DMB+343, SMB+346, SMB+350                                         } -- WAR, RNG, RDM (038-G)
mobList[zone][SMB+361].specificChildren = { true, DMB+345, SMB+358, SMB+344                                         } -- WHM, NIN, MNK (039-G)
mobList[zone][SMB+362].specificChildren = { true, DMB+355, SMB+349, SMB+352                                         } -- PLD, BLM, SAM (040-G)
mobList[zone][SMB+363].specificChildren = { true, DMB+357, SMB+353, SMB+356                                         } -- BRD, BST, DRK (041-G)
mobList[zone][SMB+364].specificChildren = { true, DMB+351, SMB+359, SMB+347                                         } -- THF, DRG, SMN (042-G)
mobList[zone][SMB+5  ].specificChildren = { true, DMB+268, SMB+276, SMB+281                                         } -- WAR, RNG, RDM (043-O)
mobList[zone][SMB+286].specificChildren = { true, DMB+280, SMB+277, SMB+274                                         } -- WHM, NIN, MNK (044-O)
mobList[zone][SMB+287].specificChildren = { true, DMB+282, SMB+275, SMB+283                                         } -- PLD, BLM, SAM (045-O)
mobList[zone][SMB+288].specificChildren = { true, DMB+271, SMB+278, SMB+270                                         } -- BRD, BST, DRK (046-O)
mobList[zone][SMB+289].specificChildren = { true, DMB+269, SMB+284, SMB+272                                         } -- THF, DRG, SMN (047-O)
mobList[zone][SMB+30 ].specificChildren = { true, DMB+293, SMB+297, SMB+307                                         } -- WAR, RNG, RDM (048-Q)
mobList[zone][SMB+311].specificChildren = { true, DMB+300, SMB+295, SMB+296                                         } -- WHM, NIN, MNK (049-Q)
mobList[zone][SMB+312].specificChildren = { true, DMB+308, SMB+304, SMB+306                                         } -- PLD, BLM, SAM (050-Q)
mobList[zone][SMB+313].specificChildren = { true, DMB+305, SMB+298, SMB+294                                         } -- BRD, BST, DRK (051-Q)
mobList[zone][SMB+314].specificChildren = { true, DMB+301, SMB+302, SMB+309                                         } -- THF, DRG, SMN (052-Q)
-- Nightmare Mobs
mobList[zone][DMB+51 ].specificChildren = { true, DMB+54, DMB+55                                                    } -- Fly           ( 021 )
mobList[zone][DMB+52 ].specificChildren = { true, DMB+56, DMB+57                                                    } -- Fly           ( 022 )
mobList[zone][DMB+53 ].specificChildren = { true, DMB+58, DMB+59                                                    } -- Fly           ( 023 )
