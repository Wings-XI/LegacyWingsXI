...
mobList[zone][SMB+31 ].pos = { 102.6545,  3.4000,   50.0912, 128   } -- Door Across Helbort's Blades
...
mobList[zone][SMB+190].pos = {  22.0000,  2.1000,    0.0000, 64    } -- Victory Square SE
mobList[zone][SMB+196].pos = { -22.0000,  2.1000,    0.0000, 64    } -- Victory Square SW
mobList[zone][SMB+199].pos = { -20.0000,  2.1000,   13.0000, 64    } -- Victory Square NW
mobList[zone][SMB+193].pos = {  20.0000,  2.1000,   13.0000, 64    } -- Victory Square NE
mobList[zone][SMB+175].pos = {   0.0329,  0.4826,   13.0260, 64    } -- Victory Square Main Path C
mobList[zone][SMB+180].pos = {   5.0000,  1.6000,    6.0000, 64    } -- Victory Square Main Path E
mobList[zone][SMB+185].pos = {  -5.0000,  1.6000,    6.0000, 64    } -- Victory Square Main Path W
...
mobList[zone][SMB+61 ].patrolPath = { 130, 0, 14, 		116, 2, 14,		148, 0, 32 		}
...
mobList[zone][SMB+190].patrolPath = { 19, 2, 5,         19, 2, -13,     19, 2, 5        }
