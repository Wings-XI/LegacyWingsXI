...
local csRegisterGlass = 184 -- The time and destination for your foray into Dynamis will be recorded on your hourglass (registering a Perpet from a Timeless)
local csEntry = 685 -- You just traded the perpetual and the msg says "You will now be warped to dynamis" "Ready!"
local csShroudedSand = 686 -- cs with cornelia where you acquire the KI Vial of Shrouded Sand
local csWin = 698 -- cs after you get win, for example in cities it more or less says "Go win the other cities and then go to Beaucedine"
