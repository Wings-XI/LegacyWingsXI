...
zones[tpz.zone.CAEDARVA_MIRE] =
{
    text =
    {
        ...
        PARTY_MIN_REQS                = 7471, -- Your party does not meet the minimum required number of ≺Numeric Parameter 0≻ members. Unable to enter area.
        ...
        DRAWS_NEAR                    = 8081, -- Something draws near!
