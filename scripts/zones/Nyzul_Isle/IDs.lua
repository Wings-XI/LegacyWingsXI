...
zones[tpz.zone.NYZUL_ISLE] =
{
    text = {
        ...
        LAMP_MUST_WAIT              = 7354, -- It appears you cannot activate this lamp for some time...
        LAMP_SPECIFIC_ORDER         = 7355, -- Apparently, this lamp must be activated in a specific order...
        LAMP_NOT_ALL_ACTIVATED      = 7356, -- Not all lights have been activated...
