...
zones[tpz.zone.RUAUN_GARDENS] =
{
    ...
    npc =
    {
        ...
        PORTALS      =
        {
            ...
            { coords = { 162.5, -31, -353.5,  168.5, -30, -347.5}, event = 3,  portal = 17310054 }, -- blue
            { coords = { 374.5, -25,   61.5,  380.5, -24,   67.5}, event = 10, portal = 17310057 }, -- blue
            { coords = {  52.5, -25,  376.5,   58.5, -24,  382.5}, event = 17, portal = 17310060 }, -- blue
            { coords = {-346.5, -25,  166.5, -340.5, -24,  172.5}, event = 24, portal = 17310063 }, -- blue
            { coords = {-270.5, -25, -277.5, -264.5, -24, -271.5}, event = 31, portal = 17310066 }, -- blue
            { coords = {-170.0, -31, -354.4, -162.0, -30, -347.2}, event = 35, portal = 17310067 }, -- blue
            { coords = {-381.0, -25,   61.5, -374.5, -24,   67.5}, event = 28, portal = 17310064 }, -- blue
            { coords = { -58.0, -25,  376.5,  -52.0, -24,  382.5}, event = 21, portal = 17310061 }, -- blue
            { coords = { 340.5, -25,  166.5,  346.5, -24,  172.5}, event = 14, portal = 17310058 }, -- blue
            { coords = { 264.5, -25, -277.5,  270.5, -24, -271.5}, event = 7,  portal = 17310055 }, -- blue
            { coords = { 454, -5, -149,  456, -3, -147}, event = 8  , seiryu = true},
            { coords = { 278, -5,  383,  281, -3,  386}, event = 15 , genbu = true},
            { coords = {-283, -5,  386, -280, -3,  389}, event = 22 , byakko = true},
            { coords = {-456, -5, -149, -454, -3, -147}, event = 29 , suzaku = true},
