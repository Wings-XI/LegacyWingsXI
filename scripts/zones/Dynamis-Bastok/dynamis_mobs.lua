...
mobList[zone][SMB+358].pos = { 76.1541, 0.0000, -77.9565, 245 } -- W1 Mog S
...
mobList[zone][SMB+288].pos = { -9.0602, 0.0000, -73.3527, 69  } -- W1 AH W
mobList[zone][SMB+280].pos = {  0.0159, 0.0000, -73.3527, 61  } -- W1 AH C
mobList[zone][SMB+291].pos = {  9.3720, 0.0000, -73.3446, 53  } -- W1 AH E
...
mobList[zone][SMB+301].pos = {  8.7503, 0.0000, -91.7739, 221 } -- W1 W of Choc
mobList[zone][SMB+327].pos = { -5.6342,-1.0008,-122.6188, 192 } -- W1 S.Gate SE
...
mobList[zone][SMB+361].pos = {-16.4154,-1.0008,-112.0800, 192 } -- W1 S.Gate C
mobList[zone][SMB+334].pos = {-31.3670,-1.0008,-122.4364, 192 } -- W1 S.Gate SW
mobList[zone][SMB+364].pos = {-31.4167,-1.0008,-111.3167, 224 } -- W1 S.Gate W
mobList[zone][SMB+305].pos = {-31.4831, 0.0000, -97.2766, 224 } -- W1 S.Gate NW
...
mobList[zone][SMB+259].pos = {-31.5587, 0.0000, -29.8180, 82  } -- W1 W of AH (NE)
mobList[zone][SMB+374].pos = {-46.8709, 0.0000, -20.4151, 49  } -- W1 W of AH (NW)
mobList[zone][SMB+157].pos = {-45.0685, 0.0000,  -2.4238, 128 } -- W1 W of Boytz (S)
...
mobList[zone][SMB+158].pos = {-64.5615, 0.0000,  41.3409, 64  } -- W1 Corner Sheds W
mobList[zone][SMB+155].pos = {-57.7503, 0.0000,  41.0368, 64  } -- W1 Corner Shed E
mobList[zone][SMB+99 ].pos = {-74.5000, 0.0000,   6.0000, 0   } -- W1 Under Bridge NE
mobList[zone][SMB+116].pos = {-74.5000, 0.0000,   0.0000, 0   } -- W1 Under Bridge E
mobList[zone][SMB+107].pos = {-74.5000, 0.0000,  -6.0000, 0   } -- W1 Under Bridge SE
mobList[zone][SMB+103].pos = {-91.2000, 0.0000,   6.0000, 0   } -- W1 Under Bridge NW
mobList[zone][SMB+119].pos = {-91.2000, 0.0000,   0.0000, 0   } -- W1 Under Bridge W
...
mobList[zone][SMB+50 ].pos = {-133.1783,-0.5393, -1.0241, 64  } -- W1 Zer N.Ramp (SW)
...
mobList[zone][SMB+33 ].pos = {-143.5524, 0.0000,  1.6522, 42  } -- W1 Zer W.Clearing (NE)
...
mobList[zone][SMB+30 ].pos = {-161.1192, 0.0000,-16.7747, 249 } -- W1 Zer W.Clearing (W)
mobList[zone][SMB+26 ].pos = {-153.0940, 0.0000,-24.0417, 211 } -- W1 Zer W.Clearing (S)
...
mobList[zone][SMB+46 ].pos = {-133.5637, 0.0000,-29.0523, 220 } -- W1 Zer S.Clearing (NW)
mobList[zone][SMB+38 ].pos = {-128.2090, 0.0000,-41.9264, 202 } -- W1 Zer S.Clearing (N)
mobList[zone][SMB+42 ].pos = {-121.9226, 0.0000,-43.2401, 183 } -- W1 Zer S.Clearing (NE)
...
mobList[zone][SMB+187].pos = {  29.6277, 0.0000, 23.8121, 54  } -- W1 O.St. CW S.Well#2
mobList[zone][SMB+235].pos = {  30.9778, 7.0000,  5.6604, 64  } -- W1 O.St. CW S.Well Base
mobList[zone][SMB+370].pos = {  49.1261, 0.0000,  8.1024, 129 } -- W1 O.St. CW Enc.#4
mobList[zone][SMB+200].pos = {  69.9259, 0.0000,  9.6869, 61  } -- W1 O.St. CW Enc.#5
mobList[zone][SMB+204].pos = {  86.0668, 0.0000,  9.5541, 61  } -- W1 O.St. CW Enc.#6
mobList[zone][SMB+181].pos = {   8.9690, 0.0000, -3.8239, 192 } -- W1 O.St. CW W Enc.#1
mobList[zone][SMB+184].pos = {   8.8837, 0.0000,-16.3382, 192 } -- W1 O.St. CW W Enc.#2
mobList[zone][SMB+190].pos = {  60.0449, 0.0000, -3.7954, 192 } -- W1 O.St. CW E Enc.#1
mobList[zone][SMB+197].pos = {  50.8795,-0.0029,-13.2487, 0   } -- W1 O.St. CW E Enc.#2
...
mobList[zone][SMB+245].pos = {   2.0604, 7.0000,-10.6099, 192 } -- W1 O.St. SW
mobList[zone][SMB+241].pos = {  21.0951, 7.0029, -5.2672, 132 } -- W1 O.St. SE
...
mobList[zone][SMB+158].eyes = dynamis.eyes.BLUE
