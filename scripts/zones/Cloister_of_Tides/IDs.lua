...
zones[tpz.zone.CLOISTER_OF_TIDES] =
{
    text =
    {
        ...
        LEVIATHAN_UNLOCKED               = 7568, -- You are now able to summon [Ifrit/Titan/Leviathan/Garuda/Shiva/Ramuh].
...
return zones[tpz.zone.CLOISTER_OF_TIDES]
