...
function onMonsterMagicPrepare(mob, target)
    ...
    elseif rnd < 0.5 then
        return 204 -- flare
    elseif not mob:hasStatusEffect(tpz.effect.BLAZE_SPIKES) and rnd < 0.75 then
...
function onMobDeath(mob, player, isKiller)
    ...
    DespawnMob(17330513, instance)
    DespawnMob(17330514, instance)
    DespawnMob(17330515, instance)
    DespawnMob(17330516, instance)
    DespawnMob(17330517, instance)
    DespawnMob(17330518, instance)
end
