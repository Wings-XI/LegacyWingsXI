...
mobList[zone][DMB+331].waves = {  1 ,nil,nil,nil,nil,nil } -- Vanguard Dragon
mobList[zone][DMB+332].waves = {  1 ,nil,nil,nil,nil,nil } -- Vanguard Dragon
mobList[zone][DMB+333].waves = {  1 ,nil,nil,nil,nil,nil } -- Vanguard Dragon
mobList[zone][DMB+334].waves = {  1 ,nil,nil,nil,nil,nil } -- Vanguard Dragon
mobList[zone][DMB+335].waves = {  1 ,nil,nil,nil,nil,nil } -- Vanguard Dragon
mobList[zone][DMB+336].waves = {  1 ,nil,nil,nil,nil,nil } -- Vanguard Dragon
mobList[zone][DMB+343].waves = {  1 ,nil,nil,nil,nil,nil } -- Vanguard Dragon
mobList[zone][DMB+344].waves = {  1 ,nil,nil,nil,nil,nil } -- Vanguard Dragon
mobList[zone][DMB+345].waves = {  1 ,nil,nil,nil,nil,nil } -- Vanguard Dragon
mobList[zone][DMB+352].waves = {  1 ,nil,nil,nil,nil,nil } -- Vanguard Dragon
mobList[zone][SMB+43 ].waves = { nil, 2 ,nil,nil,nil,nil } -- Icon Prototype TE 30
mobList[zone][SMB+60 ].waves = { nil,nil, 3 ,nil,nil,nil } -- Tombstone Prototype TE 30
