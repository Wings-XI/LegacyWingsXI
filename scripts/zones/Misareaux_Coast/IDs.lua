...
zones[tpz.zone.MISAREAUX_COAST] =
{
    text =
    {
        ...
        BEEP_BEEP                = 7572, -- Beep...beep...beep...beep...
        BEEP_CLICK_WHIR          = 7573, -- Beeep. Click, whirrr...
        BUZZ_BEEP_BEEP           = 7574, -- Buzz... Beep... beep...
        LOGGING_IS_POSSIBLE_HERE = 7601, -- Logging is possible here if you have <item>.
        SHATTERED_SHIELD         = 7655, -- "The ground here is littered with the pieces of a shattered shield..."
        SNATCHED_AWAY            = 7656, -- "The <item> is suddenly snatched away!"   
