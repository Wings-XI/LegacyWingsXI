...
SCOUTING_ASHU_TALIF = 16    -- 5th bit (16) hides "Scouting the Ashu Talif"
...
function onTrigger(player, npc)
    ...
    local allInstances = DEBUG + BLACK_COFFIN + AGAINST_ALL_ODDS + SCOUTING_ASHU_TALIF + ROYAL_PAINTER + TARGETING_CAPTAIN -- intentionally excluding the NONE option
...
function onEventUpdate(player, csid, option, target)
    if (csid == 221) then
        ...
        -- Future options
        -- option 1048576 - SCOUTING_ASHU_TALIF
