...
local repeatableKeyItems = {
    {ki = tpz.keyItem.MOOGLE_KEY, expansion = ASA, mission = tpz.mission.id.asa.THAT_WHICH_CURDLES_BLOOD},
    {ki = tpz.keyItem.BIRD_KEY, expansion = ASA, mission = tpz.mission.id.asa.SUGAR_COATED_DIRECTIVE},
    {ki = tpz.keyItem.CACTUAR_KEY, expansion = ASA, mission = tpz.mission.id.asa.ENEMY_OF_THE_EMPIRE_II},
    {ki = tpz.keyItem.BOMB_KEY, expansion = ASA, mission = tpz.mission.id.asa.SHANTOTTO_IN_CHAINS},
    {ki = tpz.keyItem.CHOCOBO_KEY, expansion = ASA, mission = tpz.mission.id.asa.BATTARU_ROYALE},
    {ki = tpz.keyItem.TONBERRY_KEY, expansion = ASA, mission = tpz.mission.id.asa.PROJECT_SHANTOTTOFICATION},
    {ki = tpz.keyItem.WHITE_CORAL_KEY, expansion = AMK, mission = tpz.mission.id.amk.DRENCHED_IT_BEGAN_WITH_A_RAINDROP},
    {ki = tpz.keyItem.BLUE_CORAL_KEY, expansion = AMK, mission = tpz.mission.id.amk.WELCOME_TO_MY_DECREPIT_DOMICILE},
    ...
    {ki = tpz.keyItem.AZURE_KEY, expansion = ACP, mission = tpz.mission.id.acp.THOSE_WHO_LURK_IN_SHADOWS_II},
    {ki = tpz.keyItem.IVORY_KEY, expansion = ACP, mission = tpz.mission.id.acp.THOSE_WHO_LURK_IN_SHADOWS_III},
    {ki = tpz.keyItem.EBON_KEY, expansion = ACP, mission = tpz.mission.id.acp.ODE_OF_LIFE_BESTOWING},
}
