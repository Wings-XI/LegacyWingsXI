...
zones[tpz.zone.AHT_URHGAN_WHITEGATE] =
{
    text =
    {
        ...
        GATE_IS_FIRMLY_CLOSED         = 1424, -- The gate is firmly closed...≺Prompt≻
        ...
        CONFIRM_ORDER                 = 4593, -- Confirming <assault order>...
        ACCESS_AZOUPH                 = 4601, -- You have not opened a path between the Chamber of Passage and the Azouph Isle staging point (Leujaoam Sanctum).Unable to use runic portal.
        ACCESS_MAMOOL                 = 4602, -- You have not opened a path between the Chamber of Passage and the Mamool Ja staging point (Mamool Ja Training Grounds).Unable to use runic portal.
        ACCESS_LEBROS                 = 4603, -- You have not opened a path between the Chamber of Passage and the Halvung staging point (Lebros Caverns). Unable to use runic portal.
        ACCESS_PERIQIA                = 4604, -- You have not opened a path between the Chamber of Passage and the Dvucca Isle staging point (Periqia).Unable to use runic portal.
        ACCESS_ILRUSI                 = 4605, -- You have not opened a path between the Chamber of Passage and the Ilrusi Atoll staging point.Unable to use runic portal.
        ACCESS_NYZUL                  = 4606, -- You have not opened a path between the Chamber of Passage and the Nyzul Isle staging point.Unable to use runic portal.
