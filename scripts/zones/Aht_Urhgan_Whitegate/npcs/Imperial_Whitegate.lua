...
function onTrigger(player,npc)
    ...
    -- one-time events at the top, then royal armor checks afterwards
    if player:getCharVar("TransformationsProgress") == 1 then
    ...
    elseif player:getCurrentMission(TOAU) == tpz.mission.id.toau.GUESTS_OF_THE_EMPIRE and player:getCharVar("AhtUrganStatus") == 1 and
