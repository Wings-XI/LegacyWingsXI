...
function onTrigger(player, npc)
    ...
    if (rank > 0 and IS_ASSAULT_ACTIVATED == 0) then
    ...
    if (csid == 275) then
        ...
        elseif (selectiontype == 2) then
            ...
            local items =
            {
                ...
                [7]  = {itemid = 18388, price = 15000},
                [8]  = {itemid = 18417, price = 15000},
                [9]  = {itemid = 14940, price = 20000},
                [10] = {itemid = 15690, price = 20000},
                [11] = {itemid = 14525, price = 20000},
            }

            local choice = items[item]
            if choice and npcUtil.giveItem(player, choice.itemid) then
                player:delAssaultPoint(2, choice.price) -- Remove from LEBROS_ASSAULT_POINT
            end
        end
    end
end