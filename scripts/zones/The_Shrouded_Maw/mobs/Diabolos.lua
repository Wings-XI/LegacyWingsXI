...
function onMobSpawn(mob)
    ...
    mob:setMobMod(tpz.mobMod.DRAW_IN, 1)    -- Change to 0 to disable draw-in for testing
    mob:addMod(tpz.mod.ACC, 10)

    -- Only add these for the CoP Diabolos NOT Prime
    local copDiabolos = ID.mob.DIABOLOS_OFFSET
    if mob:getID() >= copDiabolos and mob:getID() <= copDiabolos + 14 then  -- three instances of diabolos
