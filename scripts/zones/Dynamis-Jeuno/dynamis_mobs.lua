...
mobList[zone][SMB+24 ].pos = {  3.997, 9.000, -67.273, 192 }
mobList[zone][SMB+28 ].pos = {-22.793, 9.001, -50.028, 0   }
mobList[zone][SMB+33 ].pos = { 24.409, 9.000, -36.068, 128 }
...
mobList[zone][SMB+24 ].specificChildren = { DMB+30  } -- Cloktix_Longnail
mobList[zone][SMB+28 ].specificChildren = { DMB+27  } -- Tufflix_Loglimbs
mobList[zone][SMB+33 ].specificChildren = { DMB+13  } -- Gabblox_Magpietongue
mobList[zone][SMB+53 ].specificChildren = { DMB+34  } -- Smeltix_Thickhide
mobList[zone][SMB+58 ].specificChildren = { DMB+36  } -- Wasabix_Callusdigit
mobList[zone][SMB+63 ].specificChildren = { DMB+35  } -- Jabkix_Pigeonpecs
mobList[zone][SMB+82 ].specificChildren = { DMB+48  } -- Wyrmwix_Snakespecs
mobList[zone][SMB+99 ].specificChildren = { DMB+47  } -- Hermitrix_Toothrot
mobList[zone][SMB+121].specificChildren = { DMB+58  } -- Morgmox_Moldnoggin
mobList[zone][SMB+150].specificChildren = { DMB+60  } -- Sparkspox_Sweatbrow
mobList[zone][SMB+170].specificChildren = { DMB+113 } -- Buffrix_Eargone
mobList[zone][SMB+177].specificChildren = { DMB+114 } -- Humnox_Drumbelly
mobList[zone][SMB+198].specificChildren = { DMB+91  } -- Elixmix_Hooknose
mobList[zone][SMB+205].specificChildren = { DMB+132 } -- Trailblix_Goatmug
mobList[zone][SMB+218].specificChildren = { DMB+174 } -- Mortilox_Wartpaws
mobList[zone][SMB+234].specificChildren = { DMB+92  } -- Bandrix_Rockjaw
mobList[zone][SMB+247].specificChildren = { DMB+131 } -- Lurklox_Dhalmelneck
mobList[zone][SMB+289].specificChildren = { DMB+130 } -- Ticktox_Beadyeyes
mobList[zone][SMB+310].specificChildren = { DMB+160 } -- Karashix_Swollenskull
mobList[zone][SMB+316].specificChildren = { DMB+190 } -- Rutrix_Hamgams
mobList[zone][SMB+323].specificChildren = { DMB+204 } -- Snypestix_Eaglebeak
mobList[zone][SMB+356].specificChildren = { DMB+138 } -- Kikklix_Longlegs
mobList[zone][SMB+376].specificChildren = { DMB+221 } -- Scruffix_Shaggychest
mobList[zone][SMB+390].specificChildren = { DMB+210 } -- Mobpix_Mucousmouth
mobList[zone][SMB+416].specificChildren = { DMB+222 } -- Tymexox_Ninefingers
mobList[zone][SMB+423].specificChildren = { DMB+228 } -- Slystix_Megapeepers
mobList[zone][SMB+456].specificChildren = { DMB+208 } -- Anvilix_Sootwrists
mobList[zone][SMB+464].specificChildren = { DMB+214 } -- Distilix_Stickytoes
mobList[zone][SMB+471].specificChildren = { DMB+209 } -- Bootrix_Jaggedelbow
mobList[zone][SMB+479].specificChildren = { DMB+226 } -- Prowlox_Barrelbelly
mobList[zone][SMB+485].specificChildren = { DMB+216 } -- Jabbrox_Grannyguise
mobList[zone][SMB+491].specificChildren = { DMB+223 } -- Blazox_Boneybod
mobList[zone][SMB+504].specificChildren = { DMB+215 } -- Eremix_Snottynostril
