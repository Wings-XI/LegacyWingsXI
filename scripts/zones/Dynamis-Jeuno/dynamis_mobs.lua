...
mobList[zone][SMB+87 ].pos = { 42.000, 0.000, -20.973, 128 }
mobList[zone][SMB+88 ].pos = { 41.176, 0.000, -26.309, 128 }
mobList[zone][SMB+91 ].pos = { 37.984, 0.005,  -5.958, 92  }
mobList[zone][SMB+95 ].pos = { 30.000, 0.005, -7.000, 64   }
mobList[zone][SMB+96 ].pos = { 27.000, 0.005, -7.000, 64   }
mobList[zone][SMB+98 ].pos = { 33.000, 0.005, -7.000, 64   }
mobList[zone][SMB+99 ].pos = { 24.000, 0.000, -35.990, 0   }
mobList[zone][SMB+105].pos = { 34.867,-1.500, -56.991, 128 }
...
mobList[zone][SMB+138].pos = { -8.252, 3.000, -6.256,  38  }
mobList[zone][SMB+141].pos = {  4.692, 3.000,  0.769,  96  }
...
mobList[zone][SMB+181].pos = {-56.000, 6.000,  -2.051, 0   }
mobList[zone][SMB+183].pos = {-56.000, 6.000, -10.025, 190 }
mobList[zone][SMB+185].pos = {-56.000, 6.000,  -5.967, 0   }
...
mobList[zone][SMB+271].pos = {  5.938, 2.000,  65.998, 255 }
mobList[zone][SMB+272].pos = { -6.004, 2.000,  66.106, 128 }
...
mobList[zone][SMB+294].pos = {  2.051, 2.000,  72.000, 0   }
mobList[zone][SMB+296].pos = {-12.069, 2.000,  72.000, 128 }
mobList[zone][SMB+298].pos = { 12.000, 2.000,  66.000, 128 }
mobList[zone][SMB+300].pos = { 12.000, 2.000,  54.000, 128 }
...
mobList[zone][SMB+330].pos = {  2.042, 0.002, -74.060, 0   }
...
mobList[zone][SMB+430].pos = {-31.111, 3.000,  -9.024, 128 }
mobList[zone][SMB+433].pos = {-27.008, 3.000,  -9.024, 0   }
mobList[zone][SMB+437].pos = {-27.008, 3.000,  -5.084, 0   }
mobList[zone][SMB+440].pos = {-31.111, 3.000,  -5.074, 128 }
mobList[zone][SMB+444].pos = {-15.007, 3.000, -10.003, 128 }
mobList[zone][SMB+448].pos = {-12.072, 3.000,  -2.020, 128 }
mobList[zone][SMB+452].pos = {-8.167, 3.000,  -10.015, 128 }
...
mobList[zone][SMB+87 ].patrolPath = {   42, 0, -20,    28, 0,  -20,     42, 0, -20   } -- Dyna Entrance Top of Stairs
mobList[zone][SMB+95 ].patrolPath = {   30, 0, -7,     30, 0,  -46,     30, 0, -7    } -- E Upper Level C
mobList[zone][SMB+96 ].patrolPath = {   27, 0, -7,     27, 0,  -46,     27, 0, -7    } -- E Upper Level W
mobList[zone][SMB+98 ].patrolPath = {   33, 0, -7,     33, 0,  -46,     33, 0, -7    } -- E Upper Level E
...
mobList[zone][SMB+247].patrolPath = {    0, -5, 61,     0, 2,   44,     0,-1,53,    0, -5, 61,     } -- Palace Stairs
...
mobList[zone][SMB+157].patrolPath = {  -18, 3,  -2,   -36, 3,   -2,    -18, 3, -2    } -- N Upper Level N
mobList[zone][SMB+147].patrolPath = {  -18, 3, -10,   -36, 3,  -10,    -18, 3, -10   } -- N Upper Level S
mobList[zone][SMB+138].patrolPath = {    4, 3, -6,    -24, 3,   -6,      4, 3, -6    } -- N Upper Level C
mobList[zone][SMB+185].patrolPath = {  -56, 6, -6,    -68, 6,   -6,    -56, 6, -6    } -- AH C
mobList[zone][SMB+181].patrolPath = {  -56, 6, -2,    -68, 6,    4,    -56, 6, -2    } -- AH N
mobList[zone][SMB+183].patrolPath = {  -56, 6, -10,   -68, 6,  -14,    -56, 6, -10   } -- AH S
mobList[zone][SMB+200].patrolPath = {  -41, 8, -23,   -41, 8,  -16,    -41, 8, -23   } -- AH Stairs
mobList[zone][SMB+202].patrolPath = {  -54, 12, -22,  -61, 12, -31,    -54, 12, -22  } -- AH Lower Platform
mobList[zone][SMB+234].patrolPath = {    0, 3,  -2,     0, 3,   22,      0, 3,  -2   } -- Palace Entrance
mobList[zone][SMB+244].patrolPath = {   12, 2,  40,    12, 2,   68,     12, 2,  40   } -- Palace Interior E
mobList[zone][SMB+241].patrolPath = {  -12, 2,  40,   -12, 2,   68,    -12, 2,  40   } -- Palace Interior W
mobList[zone][SMB+258].patrolPath = {  -12, 2,  72,    12, 2,   72,    -12, 2,  72   } -- Palace Rear
mobList[zone][SMB+276].patrolPath = {    0, 2,  96,     0, 2,   76,      0, 2,  96   } -- Near Maat
mobList[zone][SMB+112].patrolPath = {   30, 0, -74,    12, 0,  -74,     30, 0, -74   } -- S Upper Level
mobList[zone][SMB+294].patrolPath = {    2, 2,  72,    10, 2,   72,      2, 2,  72   } -- Palace Repop N #1
mobList[zone][SMB+296].patrolPath = {   -2, 2,  72,   -12, 2,   72,     -2, 2,  72   } -- Palace Repop N #2
mobList[zone][SMB+298].patrolPath = {   12, 2,  68,    12, 2,   56,     12, 2,  68   } -- Palace Repop E #1
mobList[zone][SMB+300].patrolPath = {   12, 2,  54,    12, 2,   42,     12, 2,  54   } -- Palace Repop E #2
mobList[zone][SMB+306].patrolPath = {  -12, 2,  68,   -12, 2,   56,    -12, 2,  68   } -- Palace Repop W #1
mobList[zone][SMB+308].patrolPath = {  -12, 2,  54,   -12, 2,   42,    -12, 2,  54   } -- Palace Repop W #2
mobList[zone][SMB+304].patrolPath = {   12, 2,  40,    5, 2,    40,     12, 2,  40   } -- Palace Repop S #1
mobList[zone][SMB+302].patrolPath = {  -12, 2,  40,   -5, 2,    40,    -12, 2,  40   } -- Palace Repop S #2
mobList[zone][SMB+112].patrolPath = {   30, 0, -74,    12, 0,  -74,     30, 0, -74   } -- S Upper Level
...
mobList[zone][SMB+213].patrolPath = {  -56, 6, -15,   -65, 6,  -15,    -56, 6, -15   } -- AH Repop S
mobList[zone][SMB+216].patrolPath = {  -56, 6, -12,   -56, 6,    0,    -56, 6, -12   } -- AH Repop C
mobList[zone][SMB+211].patrolPath = {  -41, 8, -23,   -41, 8,  -16,    -41, 8, -23   } -- AH Repop Stairs
mobList[zone][SMB+416].patrolPath = {  -26, 0, -36,   -34, 0,  -36,    -26, 0, -36   } -- Upper Level W Repop N
mobList[zone][SMB+411].patrolPath = {  -38, 0, -40,   -38, 0,  -62,    -38, 0, -40   } -- Upper Level W Repop W
mobList[zone][SMB+407].patrolPath = {  -28, 0, -62,   -28, 0,  -44,    -28, 0, -62   } -- Upper Level W Repop E
mobList[zone][SMB+402].patrolPath = {  -34, 0, -64,   -26, 0,  -64,    -34, 0, -64   } -- Upper Level W Repop S
mobList[zone][SMB+330].patrolPath = {    2, 0, -74,     6, 0,  -74,      2, 0, -74   } -- Near Mega Boss #1
mobList[zone][SMB+336].patrolPath = {    0, 0, -80,     0, 0,  -76,      0, 0, -80   } -- Near Mega Boss #2
mobList[zone][SMB+342].patrolPath = {   -2, 0, -74,    -6, 0,  -74,     -2, 0, -74   } -- Near Mega Boss #3
mobList[zone][SMB+348].patrolPath = {    0, 0, -72,     0, 0,  -68,      0, 0, -72   } -- Near Mega Boss #4
mobList[zone][SMB+430].patrolPath = {  -31, 3, -9,    -34, 3,  -12,    -31, 3, -9    } -- Repop Upper Level N #1
mobList[zone][SMB+433].patrolPath = {  -27, 3, -9,    -24, 3,  -12,    -27, 3, -9    } -- Repop Upper Level N #2
mobList[zone][SMB+437].patrolPath = {  -27, 3, -5,    -24, 3,   -2,    -27, 3, -5    } -- Repop Upper Level N #3
mobList[zone][SMB+440].patrolPath = {  -31, 3, -5,    -34, 3,   -2,    -31, 3, -5    } -- Repop Upper Level N #4
mobList[zone][SMB+452].patrolPath = {   -8, 3, -10,    -8, 3,   -2,     -8, 3, -10   } -- Repop Upper Level NC #1
mobList[zone][SMB+448].patrolPath = {  -12, 3, -2,    -12, 3,  -10,    -12, 3, -2    } -- Repop Upper Level NC #2
mobList[zone][SMB+444].patrolPath = {  -15, 3, -10,   -15, 3,   -2,    -15, 3, -10   } -- Repop Upper Level NC #3
