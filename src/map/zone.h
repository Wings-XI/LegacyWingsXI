...
public:
    ...
    void            SetSoloBattleMusic(uint8 newMusic);
    void            SetPartyBattleMusic(uint8 newMusic);
    void            SetBackgroundMusicDay(uint8 newMusic);
    void            SetBackgroundMusicNight(uint8 newMusic);
