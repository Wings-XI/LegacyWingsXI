...
public:
    ...
    uint64_t GetLocalVar(const std::string& name) const; // Get a local var set for the isntance
    ...
    void SetLocalVar(const std::string& name, uint64_t value); // Sets a local var for the instance
