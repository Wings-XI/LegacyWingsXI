...
void LoadTrustStatsAndSkills(CTrustEntity* PTrust)
{
    ...
    // Stats ========================
    uint16 fSTR = mobutils::GetBaseToRank(PTrust, PTrust->strRank);
    uint16 fDEX = mobutils::GetBaseToRank(PTrust, PTrust->dexRank);
    uint16 fVIT = mobutils::GetBaseToRank(PTrust, PTrust->vitRank);
    uint16 fAGI = mobutils::GetBaseToRank(PTrust, PTrust->agiRank);
    uint16 fINT = mobutils::GetBaseToRank(PTrust, PTrust->intRank);
    uint16 fMND = mobutils::GetBaseToRank(PTrust, PTrust->mndRank);
    uint16 fCHR = mobutils::GetBaseToRank(PTrust, PTrust->chrRank);

    uint16 mSTR = mobutils::GetBaseToRank(PTrust, grade::GetJobGrade(PTrust->GetMJob(), 2));
    uint16 mDEX = mobutils::GetBaseToRank(PTrust, grade::GetJobGrade(PTrust->GetMJob(), 3));
    uint16 mVIT = mobutils::GetBaseToRank(PTrust, grade::GetJobGrade(PTrust->GetMJob(), 4));
    uint16 mAGI = mobutils::GetBaseToRank(PTrust, grade::GetJobGrade(PTrust->GetMJob(), 5));
    uint16 mINT = mobutils::GetBaseToRank(PTrust, grade::GetJobGrade(PTrust->GetMJob(), 6));
    uint16 mMND = mobutils::GetBaseToRank(PTrust, grade::GetJobGrade(PTrust->GetMJob(), 7));
    uint16 mCHR = mobutils::GetBaseToRank(PTrust, grade::GetJobGrade(PTrust->GetMJob(), 8));

    uint16 sSTR = mobutils::GetBaseToRank(PTrust, grade::GetJobGrade(PTrust->GetSJob(), 2));
    uint16 sDEX = mobutils::GetBaseToRank(PTrust, grade::GetJobGrade(PTrust->GetSJob(), 3));
    uint16 sVIT = mobutils::GetBaseToRank(PTrust, grade::GetJobGrade(PTrust->GetSJob(), 4));
    uint16 sAGI = mobutils::GetBaseToRank(PTrust, grade::GetJobGrade(PTrust->GetSJob(), 5));
    uint16 sINT = mobutils::GetBaseToRank(PTrust, grade::GetJobGrade(PTrust->GetSJob(), 6));
    uint16 sMND = mobutils::GetBaseToRank(PTrust, grade::GetJobGrade(PTrust->GetSJob(), 7));
    uint16 sCHR = mobutils::GetBaseToRank(PTrust, grade::GetJobGrade(PTrust->GetSJob(), 8));
