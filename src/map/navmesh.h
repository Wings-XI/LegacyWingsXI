...
public:
    ...
    uint8 maxAngleDivergenceOfPath(std::vector<position_t>* PPath); // if any points extending out from the starting point toward the end point diverge from this angle of view, return false
